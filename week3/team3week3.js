      ...
      console.log(fifteen);
      console.table(fifteen); // easier to read
      // line 67 could read const fifteen = inventors.filter(inventor=> inventor.year >=1500 && inventor.year < 1600)

      // Array.prototype.map()
      // 2. Give us an array of the inventors' first and last names
      const firstLast = inventors.map(inventor => inventor.first + ' ' + inventor.last + '/n');
      // or const firstLast = inventors.map(inventor => `${inventor.first} ${inventor.last}`);
